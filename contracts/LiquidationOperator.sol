...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    ILendingPool constant lending_pool =
    ...
    IERC20 constant usdt_pool =
        IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    IERC20 constant wbtc_pool =
        IERC20(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);
    IWETH constant weth_pool =
        IWETH(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);

    IUniswapV2Pair WBTC_WETH =
        IUniswapV2Pair(factory.getPair(WBTC_addr, WETH_addr));
    IUniswapV2Pair USDT_WETH =
        IUniswapV2Pair(factory.getPair(USDT_addr, WETH_addr));
    ...
    function operate() external {
        ...
        uint256 currWETHBalance = weth_pool.balanceOf(me);
    ...
    function uniswapV2Call(
        ...
        //order of get reserves is lowest address, lowest to highest is WBTC, WETH, USDT

        uint256 reserve_WETH_PoolA;
        uint256 reserve_USDT_PoolA;
        (reserve_WETH_PoolA, reserve_USDT_PoolA, ) = USDT_WETH.getReserves();

        uint256 reserve_WBTC_PoolB;
        uint256 reserve_WETH_PoolB;
        (reserve_WBTC_PoolB, reserve_WETH_PoolB, ) = WBTC_WETH.getReserves();

        // 2.1 liquidate the target user
        uint256 debt_repay = amount1;
        usdt_pool.approve(address(lending_pool), debt_repay);
        ...
        uint256 collWBTC = wbtc_pool.balanceOf(me);
        //    *** Your code here ***
        // 2.2 swap WBTC for other things or repay directly
        wbtc_pool.transfer(address(WBTC_WETH), collWBTC);
